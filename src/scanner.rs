use crate::scanner::ScannerResult::EOF;
        ...
        match c {
            ...
            '&' => {
                if self.match_next('&') {
                    ...
                    ScannerResult::Err("Unexpected lone &".to_string(), self.line)
                }
            }
            '|' => {
                if self.match_next('|') {
            ...
            '"' => self.string_literal(),
            _ => ScannerResult::Err("Unexpected character".to_string(), self.line)
        }
    }
